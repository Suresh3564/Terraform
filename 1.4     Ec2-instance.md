...
this is for all shot creation of vpc and ec2-instance
...
resource "aws_instance" "example" {
  ...
  user_data = <<-EOF
              ...
              <body>
                <h1>🚀 Welcome Suresh - AWS DevOps Engineer 🚀</h1>
                <p>Provisioned using Terraform</p>

                <div class="logo">☁️ AWS</div>
                <div class="logo">🔷 Azure</div>
                <div class="logo">☸️ Kubernetes</div>
